function buildGeometry() {
	...
	///// Creates vertices
	var vert1 = [[0.0, 1.0, 0.0]];	//noghteye balayi makhroot
	// barabar ba -1 chon bayad payin bashe y, baghiye noghat doreshan, baraye keshidane dayere
	for(i = 0; i < 36; i++) {
	...
	var ind1 = [];
	//////// Upper part
	j = 0;		// hamishe avalish oon noghte vasatas baad doresh
	for(i = 0; i < 36; i++) {
		ind1[j++] = 0;
		ind1[j++] = i + 1;	//1st point
		ind1[j++] = (i + 1) % 36 + 1;	//2nd point
	}
	//////// Lower part
	for(i = 0; i < 36; i++) {
		ind1[j++] = 37;
